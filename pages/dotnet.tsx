  ...
  return (
    <Layout title='Java'>
      ...
      {currentQuiz < quizDataDotNet.length ? (
        ...
        <h2 className='text-lg md:text-xl lg:text-2xl mb-6'>Você respondeu <span className='fond-bold text-2xl md:text-3xl lg:text-4xl'>{score}/{quizDataDotNet.length}</span> questões corretamente</h2>
