    ...
    <Layout title='Java'>
      ...
      {currentQuiz < quizDataWordpress.length ? (
        ...
        <div className='justify-content  text-center'>
          <h2 className='text-lg md:text-xl lg:text-2xl mb-6'>You answered<span className='fond-bold text-2xl md:text-3xl lg:text-4xl'>{score}/{quizDataWordpress.length}</span> Questions correctly</h2>
