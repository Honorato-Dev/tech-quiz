  ...
  return (
    <Layout title='Java'>
      ...
      {currentQuiz < quizDataMongoDb.length ? (
        ...
        <h2 className='text-lg md:text-xl lg:text-2xl mb-6'>You answered <span className='fond-bold text-2xl md:text-3xl lg:text-4xl'>{score}/{quizDataMongoDb.length}</span> Questions correctly</h2>
