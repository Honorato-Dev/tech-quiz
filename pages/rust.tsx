  ...
  return (
    <Layout title='Java'>
      ...
      {currentQuiz < quizDataRust.length ? (
        ...
        <h2 className='text-lg md:text-xl lg:text-2xl mb-6'>You answered<span className='fond-bold text-2xl md:text-3xl lg:text-4xl'>{score}/{quizDataRust.length}</span> questões corretamente</h2>
