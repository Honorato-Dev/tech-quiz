...
},
{
  ...
  options: [
      ...
      { text: "Um conjunto de arquivos que controlam a aparência do site", id: "c" },
      { text: "Uma extensão para adicionar funcionalidades extras ao WordPress", id: "d" }
  ],
  correct: "c"
},
...
},
{
  ...
  options: [
      ...
      { text: "Definir regras de redirecionamento e segurança do site", id: "c" },
      { text: "Armazenar informações de configuração do tema", id: "d" }
  ],
  correct: "c"
},
{
  ...
  options: [
      ...
      { text: "Uma extensão para adicionar funcionalidades extras ao WordPress", id: "c" },
      { text: "Um tipo de postagem personalizada", id: "d" }
  ],
  correct: "c"
},
{
  ...
  options: [
      ...
      { text: "Gerenciar as permissões de acesso dos usuários", id: "c" },
      { text: "Armazenar informações de configuração do tema", id: "d" }
  ],
  correct: "a"
},
...
},
{
  ...
  options: [
      ...
      { text: "Um conjunto de arquivos que controlam a aparência do site", id: "c" },
      { text: "Um componente de interface que pode ser adicionado a áreas específicas do site", id: "d" }
  ],
  correct: "d"
},
{
  ...
  options: [
      { text: "Gerenciar a instalação do WordPress", id: "a" },
      { text: "Controlar as configurações de cache do navegador", id: "b" },
      { text: "Definir funções personalizadas e modificar o comportamento do tema", id: "c" },
      { text: "Armazenar informações de configuração do tema", id: "d" }
  ],
  correct: "c"
},
{
  ...
  options: [
      ...
      { text: "Um tema otimizado para sites de notícias e revistas", id: "c" },
      { text: "Uma ferramenta de análise de tráfego do site", id: "d" }
  ],
  correct: "b"
},
{
  ...
  options: [
      ...
      { text: "Desinstalando e reinstalando o WordPress", id: "c" },
      { text: "Não é possível atualizar o WordPress", id: "d" }
  ],
  correct: "a"
},
{
  ...
  options: [
      ...
      { text: "Um tipo de conteúdo personalizado com campos e categorias específicas", id: "c" },
      { text: "Um modelo de página estática", id: "d" }
  ],
  correct: "c"
},
{
  ...
  options: [
      ...
      { text: "Um editor de bloco de conteúdo visual usado no WordPress 5.0 e posterior", id: "c" },
      { text: "Uma plataforma de aprendizado online para desenvolvedores WordPress", id: "d" }
  ],
  correct: "c"
},
{
  ...
  options: [
      ...
      { text: "Um conjunto de arquivos que controlam a aparência do site", id: "c" },
      { text: "Um componente de interface usado para navegar entre diferentes seções do site", id: "d" }
  ],
  correct: "a"
},
{
  ...
  options: [
      ...
      { text: "Anexando a imagem a um e-mail e enviando para o endereço de e-mail do site", id: "c" },
      { text: "Copiando e colando a imagem diretamente na postagem ou página", id: "d" }
  ],
  correct: "b"
},
{
  ...
  options: [
      ...
      { text: "Uma marca d'água aplicada a imagens para proteção contra cópia", id: "c" },
      { text: "Uma extensão para adicionar funcionalidades extras ao WordPress", id: "d" }
  ],
  correct: "b"
},
{
  ...
  options: [
      ...
      { text: "Um modelo de página usado como base para outras páginas", id: "c" },
      { text: "Uma página que usa HTML estático em vez de PHP dinâmico", id: "d" }
  ],
  correct: "b"
},
{
  ...
  options: [
      ...
      { text: "Um conjunto de arquivos que controlam a aparência do site", id: "b" },
      { text: "Uma extensão para adicionar funcionalidades extras ao WordPress", id: "c" },
      { text: "Um sistema para classificar e organizar conteúdo, como categorias e tags", id: "d" }
  ],
  correct: "d"
}
,
{
  ...
  options: [
      ...
      { text: "Um editor de texto básico para postagens e páginas", id: "c" },
      { text: "Uma plataforma de aprendizado online para desenvolvedores WordPress", id: "d" }
  ],
  correct: "b"
}
